        ...
        var setChangeTrigger = function(trigger_id, bind_id) {
          ...
          var changeTrigger = function() {
            ...
            for (i in Drupal.CTools.dependent.bindings[bind_id]) {
              ...
              if (Drupal.settings.CTools.dependent[id].hasOwnProperty('class') && Drupal.settings.CTools.dependent[id].class) {
                var $original = $('.' + id);
              }
              else {
                var $original = $('#' + id);
              ...
              // Add support for self instead of parent.
              if (Drupal.settings.CTools.dependent[id].hasOwnProperty('self') && Drupal.settings.CTools.dependent[id].self) {
                var object = $original;
              }
              else {
